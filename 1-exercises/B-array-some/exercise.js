...
function pairsCheck(newArray) {
  if(newArray.some(element => 
    element === null)) {

    return ('ERROR: https://nodejs.org/api/process.html#process_process_exit_code, process.exit(1)')
  } 
}

console.log(pairsCheck(pairsByIndex));
